...
def Domain(nx, ny, xblocks, yblocks, xmin, xmax, ymin, ymax, \
    ...
    if center_vars: 
        gridc = Grid('cell-centered', center_vars, nx, ny, xblocks, yblocks, \
                      xmin, xmax, ymin, ymax, \
                      user_bc_type=bc_type_center, user_bc_val=bc_val_center)

    if face_vars:
        gridx = Grid('x-face', face_vars, nx, ny, xblocks, yblocks, \
                      xmin, xmax, ymin, ymax, \
                      user_bc_type=bc_type_facex, user_bc_val=bc_val_facex)

        gridy = Grid('y-face', face_vars, nx, ny, xblocks, yblocks, \
                      xmin, xmax, ymin, ymax, \
