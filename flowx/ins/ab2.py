"""Adams-Bashforth 2nd-order time advancement routine"""

from .projection import predictor_ab2, corrector, divergence
from .stats import stats

def ab2( gridc, gridx, gridy, scalars, grid_var_list, predcorr ):

    """
    Subroutine for the fractional step Adams-Bashforth 2nd-order explicit time advancement of Navier Stokes equations
    ...
    if( predcorr == 'predictor' ):
        # Calculate predicted velocity: u* = dt*( 1.5*H(u^n) - .5*H(u^n-1) )
