...
import flowx.poisson as poisson

from .projection import predictor, corrector, divergence
from .stats import stats

def ins(gridc, gridx, gridy, scalars, grid_var_list, options=None):
    ...
    scalars.stats['ites'], scalars.stats['res'] = poisson(gridc, pres, divv)
