...
def solve_GS(grid, ivar, rvar, maxiter=3000, tol=1e-9, verbose=False):
    """Solve the Poisson system using a Gauss-Seidal method.
    ...
    while ites < maxiter and residual > tol:
        ...
        for j in range(1,ny+1):
            for i in range(1,nx+1):
                grid.data[i, j, i_ivar] = (((grid.data[i, j-1, i_ivar] +
